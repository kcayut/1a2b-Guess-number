...
if you have non-hashable items, therefore, you cannot use set and must instead use list.
...
, while in a list it takes time proportional to the list's length in the average and worst cases.
So, if you have hashable items, don't care either way about order or duplicates, and want speedy membership checking, set is better than list."""


d={ 'Integer' : 100, 'Float' : 100.000, 'string' : 'kcayut' }
print d
print(type(d))
print d.get('Integer')
print d.items
